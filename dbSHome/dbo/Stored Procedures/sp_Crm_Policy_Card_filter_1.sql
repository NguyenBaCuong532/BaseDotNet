...
CREATE procedure [dbo].[sp_Crm_Policy_Card_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Policy_Card_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Crm_Policy_Card ' + error_message()
