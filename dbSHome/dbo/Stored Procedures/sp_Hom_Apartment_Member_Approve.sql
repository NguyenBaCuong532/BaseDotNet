...
CREATE PROCEDURE [dbo].[sp_Hom_Apartment_Member_Approve] @UserID NVARCHAR(450)
    , @apartmentId BIGINT
    , @CustId NVARCHAR(50)
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                --AND NOT EXISTS 
                --(
                --	SELECT * FROM dbo.MAS_Apartment_Member a JOIN dbo.MAS_Customers b ON a.CustId = b.CustId 
                --	WHERE a.ApartmentId = @apartmentId AND b.phone = 
                --		(
                --			SELECT TOP 1 t.phone FROM dbSHome.dbo.UserInfo t
                --			WHERE t.userId = @memberUserId
                --		)
                --)
                --	set @CustId = newid()
                ...
                --	SET @CustId = 
                --	(
                --	SELECT TOP 1 b.CustId FROM dbo.MAS_Apartment_Member a JOIN dbo.MAS_Customers b ON a.CustId = b.CustId 
                --	WHERE a.ApartmentId = @apartmentId AND b.phone = 
                --		(
                --			SELECT TOP 1 t.phone FROM dbSHome.dbo.UserInfo t
                --			WHERE t.userId = @memberUserId
