...
CREATE procedure [dbo].[sp_Pay_Point_List_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Point_List_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Pay_Point_List_filter ' + error_message()
