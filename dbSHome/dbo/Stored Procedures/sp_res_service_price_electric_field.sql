...
-- =============================================
CREATE PROCEDURE [dbo].[sp_res_service_price_electric_field]
...
AS
BEGIN TRY
    DECLARE @GroupKey NVARCHAR(100) = 'config_sp_res_service_price_electric_field_group';--sys_config_data
    DECLARE @TableName NVARCHAR(100) = 'config_sp_res_service_price_electric_field';--sys_config_form
    ...
    FROM
        ...
        OUTER APPLY (SELECT TOP 1 * FROM par_electric d WHERE oid = @oid) b
