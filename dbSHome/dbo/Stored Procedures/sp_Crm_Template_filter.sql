...
CREATE procedure [dbo].[sp_Crm_Template_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Template_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Crm_Template_filter ' + error_message()
