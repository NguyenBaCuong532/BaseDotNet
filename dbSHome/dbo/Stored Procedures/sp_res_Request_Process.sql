...
CREATE procedure [dbo].[sp_res_Request_Process]
	@UserID	nvarchar(450),
	@RequestId int,
...
as
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_res_Request_Process ' + error_message()
		set @ErrorProc					= error_procedure()

		set @AddlInfo					= '@NotiId ' + @RequestId 

		exec utl_Insert_ErrorLog @ErrorNum, @ErrorMsg, @ErrorProc, 'MAS_Requests', 'SET', @SessionID, @AddlInfo
	end catch