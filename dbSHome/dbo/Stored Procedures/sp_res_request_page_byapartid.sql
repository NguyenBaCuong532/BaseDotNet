...
CREATE PROCEDURE [dbo].[sp_res_request_page_byapartid]
    @userId UNIQUEIDENTIFIER,
    @filter NVARCHAR(30) = NULL,
	@ApartmentId INT ,
	@Oid NVARCHAR(30) = NULL,
...
BEGIN TRY
	...
	declare @GridKey	nvarchar(100) = 'view_apartment_request_page'
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_apartment_request_get' + ERROR_MESSAGE();
