CREATE OR ALTER PROCEDURE [dbo].[sp_res_apartment_changeRoomCode_field] 
	...
	@buildingOid UNIQUEIDENTIFIER = NULL -- Ưu tiên: khi có thì set buildingCd từ MAS_Buildings
AS
BEGIN TRY
	SET NOCOUNT ON;
