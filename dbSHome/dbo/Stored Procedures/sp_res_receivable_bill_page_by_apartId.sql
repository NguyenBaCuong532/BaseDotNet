...
--EXEC sp_res_receivable_bill_by_apartmentId_get @userId = 'dea0d445-d934-4769-902f-843a517ebcc1',@apartmentId = 5565,@GridKey = 'view_receivable_bill_page'
-- Lịch sử hóa đơn
CREATE PROCEDURE [dbo].[sp_res_receivable_bill_page_by_apartId]
...
BEGIN TRY
	...
	declare @GridKey	nvarchar(100) = 'view_receivable_bill_page'
	...
	WHERE 
		--a.isExpected = 1 AND 
		(a.IsPayed = 0 or a.TotalAmt - a.PaidAmt > 0)
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_receivable_bill_by_apartmentId_get' + ERROR_MESSAGE();
