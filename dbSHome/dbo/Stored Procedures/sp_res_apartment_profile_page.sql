CREATE OR ALTER PROCEDURE [dbo].[sp_res_apartment_profile_page]
...
BEGIN TRY
    ...
    declare @GridKey	nvarchar(100) = 'view_apartment_profile_page'
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_apartment_profile_page' + ERROR_MESSAGE();
