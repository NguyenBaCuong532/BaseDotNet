-- Khóa/mở thẻ xe khách. Hỗ trợ @cardVehicleOid (MAS_CardVehicle.oid).
CREATE PROCEDURE [dbo].[sp_res_vehicle_guest_loked]
...
BEGIN CATCH
    ...
    SET @ErrorNum = ERROR_NUMBER(); SET @ErrorMsg = 'sp_res_vehicle_guest_loked' + ERROR_MESSAGE(); SET @ErrorProc = ERROR_PROCEDURE();
    EXEC utl_ErrorLog_Set @ErrorNum, @ErrorMsg, @ErrorProc, 'VehicleGuest', 'SET', @SessionID, @AddlInfo;
END CATCH;
