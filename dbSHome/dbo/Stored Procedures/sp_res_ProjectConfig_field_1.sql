...
BEGIN TRY
    ...
    SELECT
        CASE [data_type]
            ...
            WHEN 'nvarchar' THEN CONVERT(NVARCHAR(MAX), 
                CASE [field_name]
                    WHEN 'config_value_default' THEN d.config_value_default
                    WHEN 'config_value' THEN IIF(TRIM(ISNULL(b.config_value, '')) = '', d.config_value_default, b.config_value)
                END)
        END AS columnValue,
        [field_name],
        [view_type],
        ...
        [columnType],
        [columnObject] = CASE
                              WHEN b.config_type = 'file' AND a.field_name = 'config_value_default' THEN CONCAT([columnObject], d.config_value_default)
    ...
    FROM
        ...
        LEFT JOIN par_project_config_default d ON b.config_code = d.config_code AND b.config_type = d.config_type
