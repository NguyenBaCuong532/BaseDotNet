...
CREATE procedure [dbo].[sp_Pay_Point_Voucher_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Voucher_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Pay_Point_Voucher_filter ' + error_message()
