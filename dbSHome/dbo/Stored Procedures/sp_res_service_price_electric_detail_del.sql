...
-- =============================================
CREATE PROCEDURE [dbo].[sp_res_service_price_electric_detail_del]
...
BEGIN TRY
    ...
    EXEC sp_res_service_price_set_log @UserId, @project_code, @ArrOid, 'DELETE', 'par_electric_detail';
	
    DELETE a
    FROM
        par_electric_detail a
