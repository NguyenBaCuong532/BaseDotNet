...
CREATE procedure [dbo].[sp_res_elevator_access_floors_get]
						...
						and (T.FloorType = 'CC'
							or ((a.CardTypeId = 1 or a.CardTypeId = 3) 
								and (exists(select 1 from MAS_Apartment_Card ac 
									...
									where ac.CardId = a.CardId and ma.floorNo = t.[FloorName] and mb.ProjectCd = t.ProjectCd and mb.BuildingCd = d.buildingCd)
									)
								)
