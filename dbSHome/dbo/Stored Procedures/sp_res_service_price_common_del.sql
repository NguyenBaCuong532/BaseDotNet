...
-- Description: Cấu hình giá dịch vụ chung - Xóa bản ghi
-- =============================================
CREATE PROCEDURE [dbo].[sp_res_service_price_common_del]
...
BEGIN TRY
    ...
    EXEC sp_res_service_price_set_log @UserId, @project_code, @ArrOid, 'DELETE', 'par_common';
