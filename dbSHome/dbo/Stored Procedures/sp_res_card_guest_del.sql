...
CREATE PROCEDURE [dbo].[sp_res_card_guest_del]
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_card_guest_del' + ERROR_MESSAGE();
    SET @ErrorProc = ERROR_PROCEDURE();
    EXEC utl_ErrorLog_Set @ErrorNum, @ErrorMsg, @ErrorProc, 'CardGuest', 'DEL', @SessionID, @AddlInfo;
END CATCH;
