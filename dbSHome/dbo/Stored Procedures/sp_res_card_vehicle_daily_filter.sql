...
CREATE PROCEDURE [dbo].[sp_res_card_vehicle_daily_filter] 
...
BEGIN TRY
    ...
    DECLARE @tableKey NVARCHAR(100) = N'cardVehicle_daily_filter';
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_cardVehicle_daily_filter' + ERROR_MESSAGE();
