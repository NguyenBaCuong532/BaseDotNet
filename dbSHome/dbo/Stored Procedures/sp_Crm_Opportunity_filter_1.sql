...
CREATE procedure [dbo].[sp_Crm_Opportunity_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Opportunity_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Crm_Opportunity_filter ' + error_message()
