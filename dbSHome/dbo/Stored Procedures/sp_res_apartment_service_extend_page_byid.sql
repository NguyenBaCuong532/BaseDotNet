...
CREATE PROCEDURE [dbo].[sp_res_apartment_service_extend_page_byid]
...
BEGIN TRY
	...
	declare @GridKey	nvarchar(100) = 'view_apartment_service_extend_fee_page'
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_apartment_service_extend_get' + ERROR_MESSAGE();
