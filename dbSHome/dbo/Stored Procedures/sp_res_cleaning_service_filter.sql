...
CREATE PROCEDURE [dbo].[sp_res_cleaning_service_filter] 
...
BEGIN TRY
    ...
    DECLARE @tableKey NVARCHAR(100) = N'request_filter';
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_cleaning_service_filter' + ERROR_MESSAGE();
