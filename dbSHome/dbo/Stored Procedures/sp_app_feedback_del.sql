...
-- =============================================
-- Author: duongpx
-- Create date: 2025-09-19 07:17:16
-- Description: Xóa bản ghi từ bảng MAS_Feedbacks
-- =============================================
CREATE   procedure [dbo].[sp_app_feedback_del]
...
BEGIN TRY
    ...
    IF NOT EXISTS(SELECT 1 FROM MAS_Feedbacks WHERE [Oid] = @id)
    BEGIN
...
BEGIN CATCH
    ...
    EXEC utl_errorlog_set @ErrorNum, @ErrorMsg, @ErrorProc, N'MAS_Feedbacks', N'DEL', @SessionID, @AddlInfo;
