...
CREATE PROCEDURE [dbo].[sp_res_card_base_filter] 
...
BEGIN TRY
    ...
    DECLARE @tableKey NVARCHAR(100) = N'resident_card_base_filter';
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'resident_card_base_filter' + ERROR_MESSAGE();
