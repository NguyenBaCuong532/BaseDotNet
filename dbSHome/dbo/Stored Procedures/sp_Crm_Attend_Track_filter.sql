...
CREATE procedure [dbo].[sp_Crm_Attend_Track_filter]
	@UserId NVARCHAR(450)
...
as
	begin try
		...
		SELECT a.[id]
		  ...
		  where a.table_name = 'Attend_Track_filter' 
	...
	begin catch
		...
		set @ErrorMsg					= 'sp_Crm_Attend_Track_filter ' + error_message()
