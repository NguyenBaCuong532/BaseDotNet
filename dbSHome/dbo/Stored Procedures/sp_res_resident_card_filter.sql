...
CREATE PROCEDURE [dbo].[sp_res_resident_card_filter] 
...
BEGIN TRY
    ...
    DECLARE @tableKey NVARCHAR(100) = N'resident_card_filter';
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_resident_card_filter' + ERROR_MESSAGE();
