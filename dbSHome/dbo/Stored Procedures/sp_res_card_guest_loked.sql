...
CREATE PROCEDURE [dbo].[sp_res_card_guest_loked]
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_card_guest_loked' + ERROR_MESSAGE();
    SET @ErrorProc = ERROR_PROCEDURE();
    EXEC utl_ErrorLog_Set @ErrorNum, @ErrorMsg, @ErrorProc, 'CardGuest', 'SET', @SessionID, @AddlInfo;
END CATCH;
