...
CREATE PROCEDURE [dbo].[sp_res_service_living_meter_filter] 
...
BEGIN TRY
    ...
    DECLARE @tableKey NVARCHAR(100) = N'service_living_filter';
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_service_living_meter_filter' + ERROR_MESSAGE();
