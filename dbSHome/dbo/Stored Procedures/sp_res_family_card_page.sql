...
CREATE PROCEDURE [dbo].[sp_res_family_card_page]
...
BEGIN TRY
    ...
    BEGIN
        SELECT *
        FROM [dbo].fn_config_list_gets_lang('view_apartment_family_card_page', 0, @acceptLanguage)
        ORDER BY [ordinal];
...
BEGIN CATCH
    ...
    SET @ErrorMsg = 'sp_res_family_card_page' + ERROR_MESSAGE();
