CREATE TABLE [dbo].[EmailJobs_Test] (
    [id]          UNIQUEIDENTIFIER CONSTRAINT [DF_EmailJobs_Test_id] DEFAULT (newid()) NOT NULL,
    ...
    CONSTRAINT [PK_EmailJobs_Test] PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [FK_EmailJobs_Test_tenant_oid] FOREIGN KEY ([tenant_oid]) REFERENCES [dbo].[MAS_Projects] ([oid])
);
