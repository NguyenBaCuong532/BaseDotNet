CREATE TABLE [dbo].[MAS_Service_ReceiptAlloc] (
    ...
    [oid]          UNIQUEIDENTIFIER CONSTRAINT [DF_MAS_Service_ReceiptAlloc_oid] DEFAULT (newid()) NOT NULL,
    ...
    CONSTRAINT [FK_MAS_Service_ReceiptAlloc_tenant_oid] FOREIGN KEY ([tenant_oid]) REFERENCES [dbo].[MAS_Projects] ([oid])
);
