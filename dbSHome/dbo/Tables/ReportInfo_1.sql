CREATE TABLE [dbo].[ReportInfo] (
    ...
    [reportId]         UNIQUEIDENTIFIER CONSTRAINT [DF_ReportInfo_Oid] DEFAULT (newid()) NULL,
    [version]          NVARCHAR (50)    NULL,
    [tenant_oid]       UNIQUEIDENTIFIER NULL,
    CONSTRAINT [PK_hrm_report_info] PRIMARY KEY CLUSTERED ([report_id] ASC) WITH (FILLFACTOR = 70),
    CONSTRAINT [FK_ReportInfo_tenant_oid] FOREIGN KEY ([tenant_oid]) REFERENCES [dbo].[MAS_Projects] ([oid])
);
