CREATE TABLE [dbo].[utl_Error_Log] (
    ...
    [oid]         UNIQUEIDENTIFIER CONSTRAINT [DF_utl_Error_Log_oid] DEFAULT (newid()) NOT NULL,
    [tenant_oid]  UNIQUEIDENTIFIER NULL,
    CONSTRAINT [PK_utl_Error_Log] PRIMARY KEY CLUSTERED ([ErrorID] ASC) WITH (FILLFACTOR = 70),
    CONSTRAINT [FK_utl_Error_Log_tenant_oid] FOREIGN KEY ([tenant_oid]) REFERENCES [dbo].[MAS_Projects] ([oid])
);
