CREATE TABLE [dbo].[EmailJobs] (
    [id]          UNIQUEIDENTIFIER CONSTRAINT [DF_EmailJobs_id] DEFAULT (newid()) NOT NULL,
    ...
    CONSTRAINT [PK_EmailJobs] PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [FK_EmailJobs_tenant_oid] FOREIGN KEY ([tenant_oid]) REFERENCES [dbo].[MAS_Projects] ([oid])
);
