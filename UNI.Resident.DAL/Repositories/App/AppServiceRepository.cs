...
namespace UNI.Resident.DAL.Repositories.App
{
    ...
    /// <seealso cref="IAppServiceRepository" />
    public class AppServiceRepository : UniBaseRepository, IAppServiceRepository
    {

        public AppServiceRepository(IUniCommonBaseRepository common)
            : base(common)
        {
        }
        #region service-reg
